...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{assets/diagrams/#1}
\caption{#2}\label{#3}
\end{figure}
}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.47\textwidth,height=0.27\textheight,keepaspectratio]{assets/screenshots/#1}}\hfill
\fbox{\includegraphics[width=0.47\textwidth,height=0.27\textheight,keepaspectratio]{assets/screenshots/#2}}\\[3pt]
\fbox{\includegraphics[width=0.47\textwidth,height=0.27\textheight,keepaspectratio]{assets/screenshots/#3}}\hfill
\fbox{\includegraphics[width=0.47\textwidth,height=0.27\textheight,keepaspectratio]{assets/screenshots/#4}}
\caption{#5}\label{#6}
\end{figure}
}
