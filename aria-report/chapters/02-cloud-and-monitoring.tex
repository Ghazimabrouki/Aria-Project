...
\begin{adjustbox}{max width=\textwidth}\begin{tikzpicture}[
  ...
  fwd/.style={draw, rounded corners, align=center, text width=2.3cm, minimum height=0.85cm, fill=teal!10},
  store/.style={draw, cylinder, shape border rotate=90, aspect=0.25, align=center, text width=2.2cm, minimum height=1.1cm, fill=blue!6},
