...
const MapCanvas = forwardRef<MapRef, MapProps>(function MapCanvas(
  {
    children,
    className,
    theme: themeProp,
  ...
  useEffect(() => {
    ...
    if (!maplibregl?.Map || typeof maplibregl.Map !== 'function') {
      console.error('[mapcn] maplibregl.Map is not a constructor. maplibregl =', maplibregl);
      return;
    }
